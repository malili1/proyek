...
export const metadata: Metadata = {
  title: {
    default:
      "PodCoreX - Deploy Aplikasi dalam 15 Detik | Platform SaaS Indonesia",
    template: "%s | PodCoreX",
  },
  description:
    "PodCoreX adalah platform SaaS Indonesia untuk deploy aplikasi dengan cepat. Dapatkan template n8n, Activepieces, WAHA Plus Cloud dan lainnya. Deploy dalam 15 detik!",
  keywords: [
    "deploy aplikasi",
    "saas indonesia",
    "n8n workflow",
  ...
  openGraph: {
    ...
    description:
      "Platform SaaS Indonesia untuk deploy aplikasi dengan cepat. Template n8n, Activepieces, WAHA Plus Cloud dan lainnya.",
...
const layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <html lang="id" suppressHydrationWarning={true}>
      ...
      <body
        className={`font-satoshi flex min-h-screen flex-col dark:bg-[#151F34]`}
      >
        <ClerkProvider
          appearance={{
            baseTheme: undefined,
